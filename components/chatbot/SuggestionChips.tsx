    ...
    <div className="mt-4 flex flex-wrap justify-center gap-2 sm:gap-3">
      {SUGGESTIONS.map(({ Icon, label }) => (
        <button
          ...
          disabled={disabled}
          className="flex items-center gap-1.5 rounded-full border border-teal-400 bg-white/90 px-3 py-2 text-xs font-semibold text-teal-700 shadow-sm transition hover:bg-white disabled:cursor-not-allowed sm:px-4 sm:py-2.5 sm:text-sm"
        >
