...
from ..models.chat_models import ChatRequest, ChatResponse, ModelVariant
...
async def chat_post(request: Request) -> ChatResponse:
    ...
    if isinstance(payload, str):
        try:
            ...
            raise HTTPException(status_code=422, detail="JSON string body must contain a JSON object.") from exc
